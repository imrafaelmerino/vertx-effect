...
import static vertxeffect.Event.*;
import static vertxeffect.Failures.prism;
import static vertxeffect.core.Functions.headers2JsObj;
...
public class EventPublisher {
    ...
    public Consumer<Vertx> sentMessage(final String address,
    ...
    public Consumer<Vertx> repliedResp(final String address,
                                       final Object result,
                                       final MultiMap context) {
        return vertx -> {
            if (enabled) vertx
    ...
    public Consumer<Vertx> repliedError(final String address,
    ...
    public Consumer<Vertx> deployedVerticle(final String address,
                                            final String id) {
        return vertx -> {
            if (enabled) vertx
                    .eventBus()
    ...
    public Consumer<Vertx> deployedVerticle(final Class<?> verticle,
                                            final String id) {
        return vertx -> {
            if (enabled) vertx
                    .eventBus()
    ...
    public Consumer<Vertx> undeployedVerticle(final String address) {
        return vertx -> {
            if (enabled) vertx
                    .eventBus()
                    .publish(VertxRef.EVENTS_ADDRESS,
