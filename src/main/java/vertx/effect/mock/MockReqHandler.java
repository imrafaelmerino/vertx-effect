...
public class MockReqHandler implements Handler<HttpServerRequest> {

    protected AtomicInteger counter = new AtomicInteger(0);

    final List<MockReqResp> mockReqResp;

    public MockReqHandler(final List<MockReqResp> mockReqResp) {
