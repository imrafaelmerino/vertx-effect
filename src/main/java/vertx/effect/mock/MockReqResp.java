...
public class MockReqResp {
    ...
    private MockReqResp(final BiPredicate<Integer, HttpServerRequest> predicate) {
    ...
    public static MockReqResp when(final BiPredicate<Integer, HttpServerRequest> predicate) {
        return new MockReqResp(predicate);
    }

    public MockReqResp setHeadersResp(final IntFunction<Function<Buffer, Function<HttpServerRequest, MultiMap>>> headersResp) {
        this.headers = Objects.requireNonNull(headersResp);
        return this;
    }

    public MockReqResp setBodyResp(final IntFunction<Function<Buffer, Function<HttpServerRequest, String>>> bodyResp) {
        this.body = Objects.requireNonNull(bodyResp);
        return this;
    }

    public MockReqResp setStatusCodeResp(final IntFunction<Function<Buffer, Function<HttpServerRequest, Integer>>> statusCodeResp) {
