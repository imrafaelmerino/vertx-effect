...
final class ParallelJsArrayExp extends JsArrayExp {
    ...
    public Val<JsArray> retryEach(final Predicate<Throwable> predicate,
        ...
        if (policy == null) return Val.fail(new IllegalArgumentException("JsArrayExp.retryEach: policy is null"));
        if (predicate== null) return Val.fail(new IllegalArgumentException("JsArrayExp.retryEach: predicate is null"));
