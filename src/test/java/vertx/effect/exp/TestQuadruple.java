...
public class TestQuadruple {
    ...
    @Test
    public void test_parallel_quadruple_exp_fails_and_recover_with_success(VertxTestContext context) {
    ...
    @Test
    public void test_sequential_quadruple_exp_fails_and_recover_with_success(VertxTestContext context) {
    ...
    @Test
    public void test_parallel_quadruple_exp_fails_and_recover_with_failure(VertxTestContext context) {
    ...
    @Test
    public void test_sequential_quadruple_exp_fails_and_recover_with_failure(VertxTestContext context) {
    ...
    @Test
    public void test_parallel_quadruple_exp_recover_with_success(VertxTestContext context) {
        Quadruple.parallel(a.get(),
                           b.get(),
                           b.get(),
                           a.get()
    ...
    @Test
    public void test_sequential_quadruple_exp_recover_with_success(VertxTestContext context) {
        Quadruple.sequential(a.get(),
                             b.get(),
                             b.get(),
                             a.get()
